			...
			<div class="container-fluid subCon">
					<div class="custom-tab-1" style="display: flex; align-items: center; justify-content: space-between; font-weight: 800; color: #444444; font-size: 17px;">
						...
						<div style="display: flex;">
							<a class="btn btn-primary" href="https://f594-1-212-157-150.ngrok-free.app/study?room=${study.studyNo }" role="button" id="btn1" style="margin-bottom: 10px; background: #0070c0; border-color: #0070c0;">화상채팅</a>
