				...
				<form class="row g-3 custom-form" action="">
					...
					<div class="col-md-3">
						<input type="text" class="form-control input-default"
							placeholder="검색어를 입력해주세요" id="sword">
					</div>
					...
					<div class="col-auto">
						<button type="button" class="btn btn-success"
							data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">글쓰기</button>
					</div>
				</form>
			</div>
		</div>
		<div class="card-body">
			<div class="table-responsive" style="height: 683px;">
				<div class="row" id="boardList"
					style="width: 100%; margin: 10px; margin-right: -10px;">
			...
			<nav>
				<ul class="pagination pagination-xs">
					<li class="page-item page-indicator"><a class="page-link"
						href="javascript:void(0)"> <i class="la la-angle-left"></i></a></li>
					...
					<li class="page-item page-indicator"><a class="page-link"
						href="javascript:void(0)"> <i class="la la-angle-right"></i></a></li>
				</ul>
			</nav>
		</div>
	</div>
			...
			<div class="modal-body">
				<div class="basic-form" id="regDiv">
					<div class="form-validation">
						<form class="needs-validation" id="frm1" name="frm1"
							enctype="multipart/form-data" method="post">
							<div class="mb-3">
								<input type="hidden" name="stboWriter" id="stboWriter"
									class="form-control" id="validationCustom01" value="${stdNm }"
									required>
							</div>
							<div class="mb-3">
								<label class="col-lg-4 col-form-label" for="validationCustom01">
									제목 <span class="text-danger">*</span>
								</label> <input type="text" name="stboTitle" id="stboTitle"
							...
							<div class="mb-3">
								...
								<textarea name="stboContent" id="stboContent"
									class="form-control h-50" id="validationCustom04" rows="5"
									placeholder="내용을 입력하세요." required></textarea>
								<div class="invalid-feedback">내용을 입력해주세요.</div>
							</div>
							<div class="col-xl-6 mb-3">
								<label class="form-label mt-3">스터디선택<span
									class="text-danger">*</span></label>
								<div class="input-group">
									<select class="default-select form-control" id="selStudy"
										name=studyNo>
							...
							<div class="mb-3">
								<input class="form-control form-control-sm" id="atchFileNo"
									type="file" multiple>
							</div>
							<!-- 파일 이미지  -->
