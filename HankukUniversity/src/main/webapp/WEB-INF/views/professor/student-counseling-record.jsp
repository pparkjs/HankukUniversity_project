				...
				for(var i=0; i<res.length; i++){
					if(res[i].aprvSttsCd == 'appv'){
						...
						if(res[i].attendModeCd == '비대면'){
							appvData +=		`<td>
												<a href="https://b02e-1-212-157-150.ngrok-free.app/rtc?dscsnNo=\${res[i].dscsnNo }" class="btn btn-primary" id="rtcBtn" style="background: #0070c0; border-color:#0070c0;">입장</a>
											</td>`
						}else{
